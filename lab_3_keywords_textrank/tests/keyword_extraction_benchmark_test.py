...
class KeywordExtractionBenchmarkTest(unittest.TestCase):
    ...
    def test_benchmark(self):
        ...
        benchmark = KeywordExtractionBenchmark(
        ...
        expected_algorithms = tuple(
            map(str.lower, ("TF-IDF", "RAKE", "VanillaTextRank", "PositionBiasedTextRank"))
        )
    ...
    def test_emtpy_output(self, _):
        """
        Tests with empty output
        """
        stop_words = ("to", "a", "is", "was")
