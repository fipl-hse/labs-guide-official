...
from lab_2_classify_by_knn.main import (
    calculate_distance,
...
class PredictLanguageKnnTest(unittest.TestCase):
    ...
    def test_predict_language_knn_euclid_ideal(self):
        ...
        second_text_vectors = [
            [0.4, 0.1, 0.4, 0.3, 0, 0.21, 0.11, 0.13, 0],
        ...
        expected = ["de", 0.57297]
        actual = predict_language_knn(
            first_text_vector, second_text_vectors, language_labels, 3, metric="euclid"
        )
    ...
    def test_predict_language_knn_manhattan_ideal(self):
        ...
        expected = ["de", 1.26000]
        actual = predict_language_knn(
            first_text_vector, second_text_vectors, language_labels, 3, metric="manhattan"
        )
        self.assertEqual(expected, actual)
    ...
    def test_predict_language_knn_complex(self):
        ...
        second_text_vectors = [
            [0, 0.32, 0, 0.1, 0.5, 0.49, 0.83, 0.3, 0],
        ...
        expected = ["de", 0.47508]
        actual = predict_language_knn(
            first_text_vector, second_text_vectors, language_labels, 2, metric="euclid"
        )
        self.assertEqual(expected, actual)
    ...
    @pytest.mark.mark10
    @patch(
        "lab_2_classify_by_knn.main.calculate_distance_manhattan",
    ...
    def test_calculate_distance_manhattan_called(self, mock):
        ...
        second_text_vectors = [
            [0, 0.2, 0.63, 0.1, 0, 0.49, 0, 0.35, 0.98],
    ...
    def test_predict_language_knn_metric_bad_input(self):
        ...
        for bad_input in bad_inputs:
            actual = predict_language_knn(bad_input, bad_input, bad_input, bad_input, bad_input)
            self.assertEqual(expected, actual)
    ...
    def test_predict_language_knn_incorrect_labels(self):
        ...
        second_text_vectors = [
            [0, 0.26, 0, 0.1, 0.23, 0.49, 0, 0.32, 0],
    ...
    def test_predict_language_knn_return_value(self):
        ...
        second_text_vectors = [
            [0, 0.27, 0, 0.12, 0, 0.69, 0.64, 0.64, 0],
