...
class CalculateSimilarityTest(unittest.TestCase):
    ...
    def test_calculate_similarity_ideal(self):
        """
        Test for calculating similarity
        """
        self.assertEqual(
            0.5714285714285714, calculate_similarity([1, 2, 3, 4, 5], [5, 8, 3, 7, 2, 1, 8])
        )
        self.assertEqual(
            calculate_similarity([1, 2, 3, 4, 5], [5, 8, 3, 7, 2, 1, 8]),
    ...
    def test_calculate_similarity_non_iterable(self):
        """
        Test for calculating similarity non iterable
        """
        sequence = [1, 2, 3, 4]
