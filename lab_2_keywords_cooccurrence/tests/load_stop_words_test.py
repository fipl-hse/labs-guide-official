...
class LoadStopWordsTest(unittest.TestCase):
    ...
    def test_load_stop_words_basic_type_verification(self):
        """
        Ensure function returns right type
        """
        expected = dict
    ...
    def test_load_stop_words_basic_keys_verification(self):
        """
        Ensure function returns a dict with right keys
        """
        expected = [
            "bg",
            "cs",
    ...
    def test_load_stop_words_basic_values_verification(self):
        """
        Ensure function returns a dict with a right number of stop words
        """
        expected = 7313
        all_stop_words = []
    ...
    def test_load_stop_words_incorrect_path(self):
        """
        Ensure function returns None for incorrect path
        """
        expected = None
