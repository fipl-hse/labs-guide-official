...
class ExtractCandidateKeywordPhrasesTest(unittest.TestCase):
    ...
    def test_extract_candidate_keyword_phrases_basic(self):
        """
        Ensure function extracts candidate keyword phrases correctly
        """
        tokenized_sentences = [
    ...
    def test_extract_candidate_keyword_phrases_many_stop_words(self):
        """
        Ensure function extracts candidate keyword phrases
        with many stop words correctly
        """
        tokenized_sentences = [
            "Во во во было из времена Советского Союза исследование "
    ...
    def test_extract_candidate_keyword_phrases_stop_words_only(self):
        """
        Ensure function extracts candidate keyword phrases
        with stop words only correctly
        """
        tokenized_sentences = ["Во во во было", "было во было из из во было"]
        stop_words = ["во", "было", "из"]
        expected = []
    ...
    def test_extract_candidate_keyword_phrases_empty_inputs(self):
        """
        Ensure function returns None for empty inputs
        """
    ...
    @pytest.mark.mark8
    @pytest.mark.mark10
    def test_extract_candidate_keyword_phrases_wrong_input_type(
        self,
    ):
        """
