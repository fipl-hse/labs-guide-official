...
class ExtractCandidateKeywordPhrasesWithAdjoiningTest(unittest.TestCase):
    ...
    def test_extract_candidate_keyword_phrases_with_adjoining_basic(self):
        """
        Ensure function extracts candidate keyword phrases with adjoining correctly
        """
        ...
        actual = extract_candidate_keyword_phrases_with_adjoining(
    ...
    def test_extract_candidate_keyword_phrases_with_adjoining_phrases_do_not_contain_keywords(self):
        """
        Ensure function doesn't extract candidate keyword phrases with adjoining
        when phrases don't contain keywords
        """
        candidate_keyword_phrases = [
            ("времена", "советского", "союза", "исследование", "космоса"),
            ("одной",),
