...
class GetTopNTest(unittest.TestCase):
    ...
    def test_get_top_n_basic(self):
        """
        Ensure function gets top n correctly
        """
        top_n = 2
        max_length = 3
    ...
    def test_get_top_n_top_n_too_large(self):
        """
        Ensure function gets top n correctly when top n is too large
        """
        top_n = 1000000
        max_length = 5
        expected = [
    ...
    def test_get_top_n_arg_top_n_too_large_max_len_is_limited(self):
        """
        Ensure function gets top n correctly
        when top n is too large and max len is limited
        """
        top_n = 1000000
        max_length = 3
    ...
    def test_get_top_n_max_len_too_small(self):
        """
        Ensure function gets top n correctly when max len is too small
        """
        keyword_phrases_with_scores = {
            ("времена", "советского", "союза", "исследование", "космоса"): 23.0,
            ("важнейших", "задач"): 4.0,
    ...
    def test_get_top_n_empty_keywords(self):
        """
        Ensure function returns None for empty keywords
        """
        keyword_phrases_with_scores = {}
        top_n = 10
        max_length = 10
    ...
    def test_get_top_n_n_non_positive(self):
        """
        Ensure function returns None for not positive top n
        """
        max_length = 5
        expected = None
    ...
    def test_get_top_n_max_len_non_positive(self):
        """
        Ensure function returns None for not positive max len
        """
        top_n = 10
        expected = None
