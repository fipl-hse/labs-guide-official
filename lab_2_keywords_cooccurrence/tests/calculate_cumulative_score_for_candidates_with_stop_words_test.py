...
class CalculateCumulativeScoreForCandidatesWithStopWordsTest(unittest.TestCase):
    ...
    def test_calculate_cumulative_score_for_candidates_with_stop_words_basic(self):
        """
        Ensure function calculates cumulative score for candidates
        with stop words correctly
        """
        expected = {
        ...
        actual = calculate_cumulative_score_for_candidates_with_stop_words(
            self.candidate_keyword_phrases, self.word_scores, self.stop_words
        )
    ...
    def test_calculate_cumulative_score_for_candidates_with_stop_words_empty_candidate_kw(self):
        """
        Ensure function returns None for empty keyword phrases
        """

        expected = None
        actual = calculate_cumulative_score_for_candidates_with_stop_words(
            [], self.word_scores, self.stop_words
        )
        self.assertEqual(expected, actual)
    ...
    def test_calculate_cumulative_score_for_candidates_with_stop_words_empty_word_scores(self):
        """
        Ensure function returns None for empty word scores
        """
        expected = None
        actual = calculate_cumulative_score_for_candidates_with_stop_words(
            self.candidate_keyword_phrases, {}, self.stop_words
        )
        self.assertEqual(expected, actual)
    ...
    def test_calculate_cumulative_score_for_candidates_with_stop_words_empty_stop_words(self):
        """
        Ensure function returns None for empty stop words
        """
        expected = None
        actual = calculate_cumulative_score_for_candidates_with_stop_words(
            self.candidate_keyword_phrases, self.word_scores, []
        )
        self.assertEqual(expected, actual)
    ...
    def test_calculate_cumulative_score_for_candidates_with_stop_words_wrong_argument_types(self):
        """
        Ensure functions returns None for wrong argument types
        """
        wrong_inputs = [4.0, 4, "string", {"dict": "dict"}, True]
        expected = None
        for wrong_input in wrong_inputs:
            actual = calculate_cumulative_score_for_candidates_with_stop_words(
                wrong_input, self.word_scores, self.stop_words
            )
            self.assertEqual(expected, actual)
            actual = calculate_cumulative_score_for_candidates_with_stop_words(
                self.candidate_keyword_phrases, self.word_scores, wrong_input
            )
            self.assertEqual(expected, actual)
        ...
        for wrong_input in wrong_inputs:
            actual = calculate_cumulative_score_for_candidates_with_stop_words(
                self.candidate_keyword_phrases, wrong_input, self.stop_words
            )
            self.assertEqual(expected, actual)
    ...
    def test_calculate_cumulative_score_for_candidates_with_stop_words_stop_words_have_scores(self):
        """
        Ensure function calculates cumulative score for candidates
        with stop words correctly when stop words have scores
        """
